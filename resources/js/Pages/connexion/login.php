...
<head>
    <meta charset="utf-8">
    <title>Connexion - Binary-Cloud</title>
              ...
              <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                  ...
                  <form action="" method="POST">
                      <div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Connexion</button>
                                <p class="text-center pt-2 text-xm"><a href="inscription.php"> Vous n'avez déjà pas de compte ?</a></p>
                            </div>
                        </div>
                    </div>
                  </form>
