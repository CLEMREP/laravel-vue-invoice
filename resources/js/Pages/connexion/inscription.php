...
<head>
    <meta charset="utf-8">
    <title>Inscription - Binary-Cloud</title>
...
<section class="w-full">
                      ...
                      <div>
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-user"></i></div>
                                    <input id="prenom" name="prenom" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-user"></i></div>
                                    <input id="nom" name="nom" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-envelope"></i></div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-lock-alt"></i></div>
                        ...
                        <div class="flex -mx-3">
                          <div class="w-full px-3 mb-5">
                              ...
                              <div class="flex">
                                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-map-pin"></i></div>
                                  <input id="adresse" name="adresse" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Avenue du Général">
                              </div>
                          </div>
                        </div>
                        <div class="flex -mx-3">
                          <div class="w-1/3 px-3 mb-12">
                              ...
                              <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-map"></i></div>
                                <input id="ville" name="ville" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Caen">
                            </div>
                        </div>
                        <div class="w-1/3 px-3 mb-12">
                            <label for="" class="text-xs font-semibold px-1">Code Postal</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bxs-keyboard"></i></div>
                                <input id="code" name="code" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="14000">
                            </div>
                        </div>
                        <div class="w-1/3 px-3 mb-12">
                          <label for="" class="text-xs font-semibold px-1">Pays</label>
                          <div class="flex">
                              <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bx bx-flag"></i></div>
                              <input id="pays" name="pays" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="France">
                          </div>
                      </div>
                    </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Créer mon compte</button>
                                <p class="text-center pt-2 text-xm"><a href="login.php"> Vous avez déjà un compte ?</a></p>
                            </div>
                        </div>
                    </div>
                  </form>
  ...
  <div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a href="/" class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img class="object-cover object-center w-full h-full rounded-full" src="../admin/assets/img/logo.jpg"/>
        </a>
    </div>
</div>
</section>
