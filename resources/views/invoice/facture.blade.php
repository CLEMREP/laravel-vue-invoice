...
<div class="pdf invoice p-10 bg-white">
    ...
    <div class="flex flex-col mt-10">
        ...
        <div class="mt-8 text-right text-sm ml-auto w-auto px-6">
            <div class="mt-1" style="right: 0; display: block;">
            ...
            <div class="mt-2" style="right: 0; display: block;">
                <div class="uppercase font-semibold text-gray-400">
                    Remise
                </div>
                <div class="text-gray-900 font-semibold">
            ...
            <div class="mt-2" style="right: 0; display: block;">
                <div class="uppercase font-semibold text-right text-green-500">
                    Total HT
                </div>
                <div class="text-green-500 text-right font-semibold">
                    {{ $invoice->total }} €
                </div>
            </div>
            <p class="text-xs mt-2 text-gray-400 font-light italic">TVA non applicable art. 293b du CGI</p>
        </div>
    </div>
